...
#cancer$time = with(cancer, ifelse(is.na(time), date_censor-date_recr, time))


# Extract required columns                         
cancer_m = cancer[, c("eid" ,"status", "time")]

# Merge onto main dataset
bb = merge(bb, cancer_m, by.x="row.names", by.y="eid")
...
annotate_figure(p, 
                top = text_grob("Cancer Mortality", face = "bold"),
